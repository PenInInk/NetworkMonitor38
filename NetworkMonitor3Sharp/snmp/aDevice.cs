...
public class aDevice
{
	...
	public Enterprise GetEnterprise(string SystemObjectId)
	{
        ...
        if (SystemObjectId.Contains(".9.1.2959"))
		{
			return Enterprise.catalist1000;
		}
		if (SystemObjectId.Contains(".9.1.1208"))
		{
			return Enterprise.catalistL2Switch;
		}
		if (SystemObjectId.Contains(".9.1.2066"))
		{
			return Enterprise.catalistL3Router;
		}
		if (SystemObjectId.Contains(".9.1."))
		{
			return Enterprise.cisco;
		}
		if (SystemObjectId.Contains(".248"))
		{
			return Enterprise.Hirschmann;
		}
		if (SystemObjectId.Contains(".16177"))
		{
			return Enterprise.Westermo;
		}
		if (SystemObjectId.Contains(".24062"))
		{
			return Enterprise.Korenix;
		}
		if (SystemObjectId.Contains(".318"))
		{
			return Enterprise.APC;
		}
		if (SystemObjectId.Contains(".4329."))
		{
			return Enterprise.ScalanceXR328;
		}
		if (SystemObjectId.Contains(".935."))
		{
			return Enterprise.PPC;
		}
		if (log.IsDebugEnabled)
		{
			log.Debug("SetEnterprise unknown " + SystemObjectId);
		}
